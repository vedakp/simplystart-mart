...
export class MyAddressesPage implements OnInit {
  ...
  constructor(public actionSheetController: ActionSheetController, public auth:AuthService) { }
  primaryAddress = 1;
  address : any = []
//   addresses = [{
//     id:1,
...
// }
  ...
  ngOnInit() {
    this.address['billing'] = this.auth.userData['billing'];
    this.address['shipping'] = this.auth.userData['shipping'];
  }
